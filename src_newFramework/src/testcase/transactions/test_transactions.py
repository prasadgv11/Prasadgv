"""
Skeleton test for the transactions module - establishes the naming/marker
convention only. No demo backend exists yet, so this intentionally fails
with a clear NotImplementedError via TransactionsPage._todo_action()
...
class TestTransactions:
    def test_transactions_placeholder(self, page):
        ...
        with pytest.raises(NotImplementedError):
            transactions_page._todo_action(data={}, loc=None)
