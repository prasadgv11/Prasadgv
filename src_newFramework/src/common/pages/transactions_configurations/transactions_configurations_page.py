"""
TransactionsConfigurationsPage - lightweight skeleton for the transactions_configurations module.
...
class TransactionsConfigurationsPage(BasePage):
    def __init__(self, page):
        super().__init__(page, module_name="TransactionsConfigurations")
