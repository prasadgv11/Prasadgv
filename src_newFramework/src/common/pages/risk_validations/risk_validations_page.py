"""
RiskValidationsPage - lightweight skeleton for the risk_validations module.
...
class RiskValidationsPage(BasePage):
    def __init__(self, page):
        super().__init__(page, module_name="RiskValidations")
