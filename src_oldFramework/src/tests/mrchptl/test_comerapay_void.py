...
@allure.feature("To Verify the ADPAy EN Comerapay Void Transactions for Versions 1.0.1, 1.0.6 & 1.0.7")
def test_ADPAY_comerapay_void(page, data):
    demo = demoPage(page)
...
# Arabic changes for Comerapay Purchase & Void Transaction
...
@pytest.mark.sanity
@pytest.mark.parametrize("data", purchase_data)
@allure.feature("To Verify the ADPAy AR Comerapay Void Transactions for Versions 1.0.1, 1.0.6 & 1.0.7")
