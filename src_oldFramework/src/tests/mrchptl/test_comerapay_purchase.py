...
@allure.feature("To Verify the ADPAy EN Comerapay Purchase Transactions for Versions 1.0.1, 1.0.6 & 1.0.7")
def test_ADPAY_comerapay_Purchase(page, data):
    demo = demoPage(page)
    ...
    demo.click_buy()
    ComeraPurchase.verify_payment_status()
    
# Arabic changes for Comerapay Purchase Transaction
...
@pytest.mark.sanity
@pytest.mark.parametrize("data", purchase_data)
@allure.feature("To Verify the ADPAy AR Comerapay Purchase Transactions for Versions 1.0.1, 1.0.6 & 1.0.7")
def test_ADPAY_comerapay_Purchase_AR(page, data):
    demo = demoPage(page)
    ComeraPurchase= PurchasePage(page)
    demo.open_base()
    demo.go_purchase()
