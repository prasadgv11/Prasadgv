...
@allure.feature("To Verify the MPAY Saved card Purchase Transactions for Versions 1.0.1 & 1.0.5")
def test_MPAY_auth_saved_card(page, data):
    ...
    demo.click_buy()
    savedcardauth.click_saved_card(
        sc_cvv=data["cvv"]
    )
    savedcardauth.click_charity_checkbox(
