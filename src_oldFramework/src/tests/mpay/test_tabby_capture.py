...
@allure.feature("To Verify the MPAy Tabby EN Capture Transactions for Versions 1.0.1 & 1.0.5")
...
@pytest.mark.sanity
@pytest.mark.parametrize("data", purchase_data)
@allure.feature("To Verify the MPAy Tabby AR Capture Transactions for Versions 1.0.1 & 1.0.5")
