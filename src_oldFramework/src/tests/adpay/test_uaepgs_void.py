...
@allure.feature("To Verify the ADPAy UAEPGS Void Transactions for Versions 1.0.1, 1.0.6 & 1.0.7")
   
def test_ADPAY_UAEPGS_void(page, data):
    demo = demoPage(page)
...
#   UaepgsPurchase.click_back_to_merchant()
    ...
    # Arabic changes for UAEPGS Purchase & VOid Transaction
