...
@allure.feature("To Verify the ADPAy EN Purchase Transactions for Versions 1.0.1 & 1.0.6")
def test_ADPAY_cardpurchase(page, data):
    ...
    demo.click_buy()
    purchase.verify_payment_status()

# # Arabic changes for Purchase Transaction
...
# @pytest.mark.sanity
# @pytest.mark.parametrize("data", purchase_data)
# @allure.feature("To Verify the ADPAy AR Purchase Transactions for Versions 1.0.1, 1.0.6 & 1.0.7")
# def test_ADPAY_cardPurchase_AR(page, data):
#     demo = demoPage(page)
#     purchase=PurchasePage(page)
#     demo.open_base()
#     demo.go_purchase()
