...
@allure.feature("To Verify the ADPAy EN Comerapay Auth Transactions for Versions 1.0.1, 1.0.6 & 1.0.7")
def test_ADPAY_comerapay_authorization(page, data):
    ...
    demo.click_buy()
    ComeraAuth.verify_payment_status()
    
# # Arabic changes for Comerapay Auth Transaction
...
# @pytest.mark.sanity
# @pytest.mark.parametrize("data", purchase_data)
# @allure.feature("To Verify the ADPAy AR Comerapay Auth Transactions for Versions 1.0.1, 1.0.6 & 1.0.7")
...
#     ComeraAuth.click_charity3_others_AR(charity_amt=data["charity_amount"])
...
#         ComerapayOTP=data["ComerapayOTP"]
#     )
#     # ComeraAuth.add_email(email=data["email"])
#     ComeraAuth.pay()
#     ComeraAuth.verify_payment_ADPay()
#     ComeraAuth.capture_payment_id()
#     demo.go_back_home()
