...
@allure.feature("To Verify the ADPAy UAEPGS Capture Transactions for Versions 1.0.1, 1.0.6 & 1.0.7")
   
def test_ADPAY_UAEPGS_AuthCapture(page, data):
    demo = demoPage(page)
...
# Arabic changes for UAEPGS Auth & Capture Transaction
...
def test_ADPAY_UAEPGS_AuthCapture_AR(page, data):
    demo = demoPage(page)
    UaepgsAuth = PurchasePage(page)
    demo.open_base()
    demo.go_authorization()
