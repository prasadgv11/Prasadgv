...
def test_ADPAY_Master_savedcardauth_AR(page, data):
    demo = demoPage(page)
    ...
    demo.click_buy()
    savedcardauth.verify_adpay_summary_header_AR()
    savedcardauth.verify_Dhiramsymbol_AR()
    savedcardauth.click_charity1_amt5_AR()
    savedcardauth.click_charity1_amt10_AR()
    savedcardauth.click_charity1_others_AR(charity_amt=data["charity_amount"])
    savedcardauth.click_charity2_amt5_AR()
    savedcardauth.click_charity2_amt10_AR()
    savedcardauth.click_charity2_others_AR(charity_amt=data["charity_amount"])
    savedcardauth.click_charity3_amt5_AR()
    savedcardauth.click_charity3_amt10_AR()
    savedcardauth.click_charity3_others_AR(charity_amt=data["charity_amount"])
    savedcardauth.click_change_AR()
...
def test_ADPAY_Amex_savedcardauth_AR(page, data):
    demo = demoPage(page)
    savedcardauth=PurchasePage(page)
    demo.open_base()
    demo.go_authorization()
...
def test_ADPAY_Visa_savedcardauth_AR(page, data):
    demo = demoPage(page)
    savedcardauth=PurchasePage(page)
    demo.open_base()
    demo.go_authorization()
...
def test_ADPAY_Jaywan_savedcardauth_AR(page, data):
    demo = demoPage(page)
    savedcardauth=PurchasePage(page)
    demo.open_base()
    demo.go_authorization()
