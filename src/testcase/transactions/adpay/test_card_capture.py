...
class TestFabAdpayTransactions(object):
        def test_adpay_card_capture(self, page, data):
            transactions = _complete_adpay_card(page, data, "authorization")
            ...
            transactions.go_to_transaction(BANK_NAME, "capture")
            transactions.fill_capture_form(BANK_NAME, data)
