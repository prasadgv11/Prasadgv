"""
PortalTransactionsPage - lightweight skeleton for the portal_transactions module.
...
class PortalTransactionsPage(BasePage):
    def __init__(self, page):
        super().__init__(page, module_name="PortalTransactions")
