"""
EcentricSpecificPage - lightweight skeleton for the ecentric_specific module.
...
class EcentricSpecificPage(BasePage):
    def __init__(self, page):
        super().__init__(page, module_name="EcentricSpecific")
